...
class Proceso:
    ...
    @property
    def quantum_transcurrido(self) -> str:
        return self._quantum_transcurrido

    @quantum_transcurrido.setter
    def quantum_transcurrido(self, quantum_transcurrido:str) -> None:
        self._quantum_transcurrido = quantum_transcurrido
    ...
    @tamanio.setter
    def tamanio(self, tamanio: str) -> None:
    ...
    @frames.setter
    def frames(self, frames: str) -> None:
        self._frames = frames
    ...
    def __str__(self) -> str:
        return f"ID: {self._idp} Tiempo Llegada: {self._tiempo_llegada}"
